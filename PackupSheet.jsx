...
const COLUMNS = [
  { key: "time", label: "TIME", width: "90px", icon: "\u23F0" },
  { key: "staff", label: "STAFF", width: "90px", icon: "\uD83D\uDC64" },
  { key: "espresso", label: "ESPRESSO", width: "110px", icon: "\u2615" },
  { key: "milkAddOns", label: "MILK / ADD-ONS", width: "110px", icon: "\uD83E\uDD5B" },
  { key: "ice", label: "ICE", width: "90px", icon: "\uD83E\uDDCA" },
  { key: "syrup", label: "SYRUP", width: "70px", icon: "\uD83C\uDF6F" },
  { key: "extras", label: "EXTRAS", width: "120px", icon: "\uD83D\uDCE6" },
    ...
    return (
      <textarea
        ...
        style={{
          width: "100%", minHeight: "36px", border: "2px solid #A259FF",
          borderRadius: "6px", padding: "6px 8px", fontFamily: "'DM Sans', sans-serif",
          fontSize: isNote ? "11px" : "12px", lineHeight: "1.4", resize: "vertical",
  ...
  return (
    <div
      ...
      style={{
        ...
        transition: "background 0.15s", fontSize: isNote ? "11px" : "12px", lineHeight: "1.4",
...
function EventRow({ event, dayId, onChange, onDelete }) {
  ...
  return (
    <tr style={{ borderBottom: "1px solid #E0E0E0" }}>
      <td style={{ padding: "8px 10px", position: "sticky", left: 0, zIndex: 2, background: "#fff", borderRight: "2px solid #E0E0E0", minWidth: "140px", maxWidth: "180px" }}>
                  ...
                  <table style={{ width: "100%", borderCollapse: "collapse", tableLayout: "fixed" }}>
                    <thead>
                      <tr style={{ background: "#FAFAFA" }}>
                        <th style={{ padding: "8px 10px", textAlign: "left", fontSize: "9px", fontWeight: 700, textTransform: "uppercase", letterSpacing: "1.2px", color: "#999", position: "sticky", left: 0, zIndex: 2, background: "#FAFAFA", borderRight: "2px solid #E0E0E0", borderBottom: "1px solid #E0E0E0", minWidth: "140px" }}>Event</th>
                        {COLUMNS.map((col) => (
                          <th key={col.key} style={{ padding: "8px 8px", textAlign: "left", fontSize: "9px", fontWeight: 700, textTransform: "uppercase", letterSpacing: "1px", color: "#999", borderBottom: "1px solid #E0E0E0", minWidth: col.width, whiteSpace: "nowrap" }}>{col.icon} {col.label}</th>
                        ))}
                      </tr>
                    </thead>
                    <tbody>
